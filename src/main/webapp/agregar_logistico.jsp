    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title" id="from-actions-multiple">Agregar Logistico</h4>
           ...
           <div class="alert alert-icon-left alert-success alert-dismissible mb-2" role="alert">
            ...
            <div class="alert alert-icon-left alert-danger alert-dismissible mb-2" role="alert">
             ...
             <%}%>
              ...
              <form class="form" action="Registrar_Logistico.do"  method="Request">
                  ...
                  <div class="form-body">
                    ...
                    <div class="row">
                      <div class="form-group col-12 mb-2">
                        ...
                        <input type="number" maxlength="30" name="clogistica" class="form-control mb-3" placeholder="Capacidad Personas" required=""/>
                      </div>
                    </div>
                    <div class="row">
                      <div class="form-group col-12 mb-2">
                          <button type="submit" class="btn mb-1 btn-success btn-icon btn-lg btn-block"><i class="fa fa-check-circle"></i>
                    Agregar Logistico</button>
                      </div>
                    </div>
                  </div>
                </div>
