<%-- 
    ...
    Author     : Daniel
--%>
<%@page import="Dao.LogisticoJpaController"%>
                ...
                <div class="main-content">
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h1 class="card-title" id="from-actions-multiple">Modificar Logistico</h1>
                  ...
                  if (registrado == "registrado") {%>
                                            <div class="alert alert-icon-left alert-success alert-dismissible mb-2" role="alert">
                                                ...
                                                <strong>Perfecto!</strong>Se ha Modificado Correctamente. El recurso Logistico
                 ...
                 if (registrado == "eliminado") {%>
                                            <div class="alert alert-icon-left alert-success alert-dismissible mb-2" role="alert">
                                                ...
                                                <strong>Perfecto!</strong>Se ha Eliminado Correctamente. El Recurso Logistico
                                            ...
                                            <%
                                                ...
                                                rs = smt.executeQuery("select * from logistico");
                                                //Creamo la Tabla:  
                                                LogisticoJpaController s = new LogisticoJpaController(cn.getBd());
                                                                    ...
                                                                    <table class="table text-center">
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            <tr>                    
                                                                                ...
                                                                                <td><%= rs.getInt(3)%>  Personas</td>
                                                                           
                                                                                
                                                                        <form name="msitios" action="Modificar_Logistico.do" > 
                                                                          <td>
                                                                            <button id="send"  type="submit" class="btn btn-raised btn-icon btn-warning"><i class="icon-note  "></i></button>
                                                                            </td>
                                                                            <input name="id" style="visibility: hidden" value="<%= rs.getInt(1)%>"/>  
                                                                        </form>
                                                                        
                                                                        <form name="msitiose" action="Eliminar_Logistico.do" > 
                                                                            <td>
