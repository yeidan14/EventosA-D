...
<div class="row">
  ...
  <div class="row match-height"> 
      ...
      <div class="content-header">El Sitio que se ha Agregado Es:</div>  <br>                                                   
    ...
    <div class="content-header">Selecciona Que tipo de Logistica desea Para Continuar:</div>
                ...
                <tr role="row" class="odd">
                   ...
                   <form name="msitiose" action="SolicitudLS.do" > 
                    <td>
                        
             <button type="submit" class="btn btn-raised btn-outline-success round btn-min-width mr-1 mb-1">Solicitar</button>                                              
             
                    </td>
                    <input name="idlogistico" style="visibility: hidden" value="<%=rs.getString(1)%>"/> 
