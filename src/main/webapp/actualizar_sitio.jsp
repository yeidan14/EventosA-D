    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title" id="from-actions-multiple">Actualizar  Sitio</h4>
            ...
            <div class="alert alert-icon-left alert-danger alert-dismissible mb-2" role="alert">
             ...
             <% String prueba=(String)request.getAttribute("estado");
                        System.err.println(""+prueba);
                            Sitio s = (Sitio) request.getAttribute("sitio");

                        %>

                        <form class="form" action="Actualizar_Sitio.do"  >
                  ...
                  <div class="form-body">
                    <div class="row">
                      <div class="form-group col-12 mb-2">
                        ...
                        <input type="text" id="eventRegInput1" value="<%= s.getNombre()%>" class="form-control" placeholder="Nombre del Sitio" name="nsitio" required="">
                        <input style="visibility: hidden" type="text" id="eventRegInput1" value="<%= s.getIdSitio()%>" class="form-control" placeholder="Nombre del Sitio" name="id" required="">
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="form-group col-12 mb-2">
                        ...
                        <input type="number" name="csitio" value="<%= s.getCapacidad()%>" class="form-control mb-3" placeholder="Capacidad" required=""/>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="form-group col-12 mb-2">
                        ...
                        <input type="date" id="eventRegInput4" value="<%= s.getFechaIni()%>" class="form-control" placeholder="fecha de inicio" name="fechasitio" required="">
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="form-group col-12 mb-2">
                        ...
                        <input type="text" id="eventRegInput5" value="<%= s.getUbicacion()%>" class="form-control" name="ubicacion" placeholder="Ubicacion del Sitio " required="">
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <select id="projectinput5" name="estado" class="form-control"required="">                        
                          <option <%if(s.getEstado().equals("Ocupado")){%> selected="true"<%}%> value="Ocupado">Ocupado</option>
                        <option  <%if(s.getEstado().equals("Libre")){%> selected="true"<%}%> value="Libre">Libre</option>
