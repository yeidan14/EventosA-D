...
import Controller.Sitios.Modificar_Sitio;
 ...
 * @author Daniel
 */
public class Modificar_Logistico extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       try {
           ...
           if(b==null){
                ...
                request.setAttribute("logis", b);
                 String estado = "encontrado";
                request.setAttribute("estado", estado);   
                request.getRequestDispatcher("actualizar_logistico.jsp").forward(request, response);
            }
        } catch (Exception ex) {
