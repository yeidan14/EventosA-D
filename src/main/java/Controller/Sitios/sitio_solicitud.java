 ...
 * @author Daniel
 */
public class sitio_solicitud extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       try { 
          ...
          Sitio si=s.findSitio(id);
          request.setAttribute("sitio", si);
          request.getRequestDispatcher("logistico_sitio.jsp").forward(request, response);
         
        
         }catch(Exception ex){
               Logger.getLogger(Eliminar_Sitio.class.getName()).log(Level.SEVERE, null, ex);
           response.sendRedirect("logistico_sitio.jsp");
