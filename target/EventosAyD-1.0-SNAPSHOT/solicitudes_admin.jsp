...
<%if (session.getAttribute("admin") == null) {
        response.sendRedirect("iadmin.jsp");
    }%>
...
<html lang="en" class="loading">
  ...
  <div class="row">
    <div class="col-12 mt-3 mb-1">
      ...
      <div class="content-header">Apareceran Solicitudes Dependiendo de quien las Relaice</div>
  ...
  <div class="row match-height">
              ...
              <thead>
               ...
               <%      while (rs.next()) {
               if(rs.getString(2).equals("Evaluando")){
               %>
            ...
            <tbody>
                ...
                <form name="msitiose" action="Aceptar_Solicitud.do" > 
                    <td>                        
             <button type="submit" class="btn btn-raised btn-outline-success round btn-min-width mr-1 mb-1">Aceptar</button>                                              
             ...
             <button type="submit" class="btn btn-raised btn-outline-danger round btn-min-width mr-1 mb-1">Eliminar</button>                                              
